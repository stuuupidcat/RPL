...
pub fn pat_cfg_to_graphviz(patterns: &FnPatternBody<'_>, f: &mut impl Write, config: &Config) -> io::Result<()> {
...
pub fn pat_ddg_to_graphviz(patterns: &FnPatternBody<'_>, f: &mut impl Write, config: &Config) -> io::Result<()> {
